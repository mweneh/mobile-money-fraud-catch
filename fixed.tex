...
\begin{tikzpicture}[
    ...
    % Phase 3: Modeling
    % Added text width to allow itemize environment
    \node (models) [process, right=3.5cm of imbalance, minimum height=3cm, fill=red!10, text width=4cm] {
...
\vspace{0.6em}
\textbf{Figure~\thefigure: Methodological Workflow from Data Ingestion to Model Optimisation}\par
\small The framework follows a CRISP-DM–aligned pipeline, incorporating parallel imbalance-handling strategies and threshold optimisation for fraud detection.
